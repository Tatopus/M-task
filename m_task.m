...
trigger = []; %triggers { 4: negative_weak; 5: negative_strong; 6:neutral_weak; 7: neutral_strong, 8:key press}
correct_press = 0;
%% 設定TRIGGER 發送
clear device
...
trigger_weak(weak_index >= neg_words_num+1) = 6; %neutral_weak
%prepare strong trigger
trigger_strong(strong_index < neg_words_num+1) = 5; %negative_strong;
trigger_strong(strong_index >= neg_words_num+1) = 7 ; %neutral_strong;
